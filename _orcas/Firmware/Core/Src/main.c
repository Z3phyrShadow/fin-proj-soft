...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TILT_MOTOR_STEP_Pin|TILT_MOTOR_DIR_Pin|LED_D2_Pin|LED_D1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PAN_MOTOR_STEP_GPIO_Port, &GPIO_InitStruct);
